...
const MnemonicDisplay: React.FC<MnemonicDisplayProps> = ({ phrase }) => {
  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-4 p-2 md:p-4 bg-gray-900 rounded-xl text-white">
      {words.map((word, index) => (
        <div
          key={index}
          className="flex items-center space-x-1 sm:space-x-2 bg-gray-800 rounded-md px-3 py-2"
        >
