...
function WalletLogin({
  ...
  const handleRecoveryFromPrivateKey = (
  ...
  const handleRecoveryFromPassphrase = (
    event: React.MouseEvent<HTMLButtonElement>,
  ) => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center h-screen w-screen px-2 md:px-0">
        ...
        <TabsContent value="privateKey">
          <Card className="w-full h-full text-left">
            <CardHeader>
              ...
              <CardDescription>
                Please enter your private key to recover your wallet. It never
                leaves your device.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="passphrase">
          <Card className="w-full h-full text-left">
            <CardHeader>
              ...
              <CardDescription>
                Enter your 12 or 24 word passphrase to recover your wallet. It
